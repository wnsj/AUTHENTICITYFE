			...
			<div class="tab-pane fade in active martop" id="basic">
				<div id="buildInputBox" class="clearfix">
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">楼盘名称</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
							<input type="text" class="form-control" v-model="addParam.htName" placeholder="必填">
						</div>
					</div>
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">楼盘经度</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">楼盘纬度</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">产权年限</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">容积率</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">绿化率</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">售楼地址</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">楼盘特点</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">物业地址</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">装修情况</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">占地面积</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">总户数</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">建筑风格</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">开发周期</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">建筑面积</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">物业公司</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">物业费</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">停车位</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">别名</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">位置类型</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">位置</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">环线</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">类型</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">户型</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">热销值</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">人气值</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">热搜值</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">特价</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">推荐户型</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">优选楼盘</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">品质楼盘</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">优惠楼盘</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">最近开盘</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">最小总价</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">最大总价</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">最小单价</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">最大单价</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">最小面积</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">最大面积</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">开盘时间</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">销售情况</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">开发商</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">特色标签</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">楼盘地址</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">联系方式</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">省份</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">加推时间</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">预交房时间</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">户型图</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">小区环境</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">实景图</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">全景看房</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">头图</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">视频</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
					...
					<div class="col-md-6 form-group clearfix">
						<label class="col-md-3 control-label text-right nopad end-aline" style="padding:0;line-height:34px;">项目介绍</label><span
						 class="sign-left">:</span>
						<div class="col-md-8">
							<textarea style="height: 300px;width: 400px;" v-model="addParam.projectIntroduction" placeholder="项目介绍"></textarea>
						</div>
					</div>
