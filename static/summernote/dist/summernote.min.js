	...
	return function(t) {
		...
		52: function(t, e, n) {
			...
			var s = r.a.create('<div class="note-editor note-frame panel panel-default"/>'),
				...
				y = r.a.create('<div id="" class="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', (function(t,
					e) {
					e.fade && t.addClass("fade"), t.attr({
						"aria-label": e.title
					}), t.html(['<div class="modal-dialog">', '<div class="modal-content">', e.title ?
						'<div class="modal-header"><button type="button" class="close"  id="" aria-label="Close" aria-hidden="true">&times;</button><h4 class="modal-title">' +
...
$(document).on('mouseover',function () {
    ...
    $('#basic').on('mouseover','.note-toolbar',function () {
        $(this).children().children('.note-btn[data-original-title="链接 (CTRL+K)"]').attr('id','noteBtnLink');
        $(this).children().children('.note-btn[data-original-title="图片"]').attr('id','noteBtnImg');
        $(this).children().children('.note-btn[data-original-title="视频"]').attr('id','noteBtnVideo');
        $(this).children().children('.note-btn[data-original-title="帮助"]').attr('id','noteBtnHelp');

    })

    $('#basic').on('mouseover','.note-editor',function () {
        $(this).children('.modal[aria-label="插入链接"]').attr('id','noteModalLink');
        $(this).children('.modal[aria-label="插入链接"]').children().children().children().children('.close[aria-label="Close"]').attr('id','closeBtnLink');

        $(this).children('.modal[aria-label="插入图片"]').attr('id','noteModalImg');
        $(this).children('.modal[aria-label="插入图片"]').children().children().children().children('.close[aria-label="Close"]').attr('id','closeBtnImg');

        $(this).children('.modal[aria-label="插入视频"]').attr('id','noteModalVideo');
        $(this).children('.modal[aria-label="插入视频"]').children().children().children().children('.close[aria-label="Close"]').attr('id','closeBtnVideo');

        $(this).children('.modal[aria-label="帮助"]').attr('id','noteModalHelp');
        $(this).children('.modal[aria-label="帮助"]').children().children().children().children('.close[aria-label="Close"]').attr('id','closeBtnHelp');
    })




    $('#basic').on('click','#closeBtnLink',function () {
        $(this).parent().parent().parent().parent().hide();
        $('.modal-backdrop').eq(1).remove();
    })
    $('#basic').on('click','#noteBtnLink',function () {
        $(this).parent().parent().siblings('.modal[aria-label="插入链接"]').show();
        $('.modal-backdrop').eq(1).remove();
    })

    $('#basic').on('click','#closeBtnImg',function () {
        $(this).parent().parent().parent().parent().hide();
        $('.modal-backdrop').eq(1).remove();
    })
    $('#basic').on('click','#noteBtnImg',function () {
        $(this).parent().parent().siblings('.modal[aria-label="插入图片"]').show();
        $('.modal-backdrop').eq(1).remove();
    })

    $('#basic').on('click','#closeBtnVideo',function () {
        $(this).parent().parent().parent().parent().hide();
        $('.modal-backdrop').eq(1).remove();
    })
    $('#basic').on('click','#noteBtnVideo',function () {
        $(this).parent().parent().siblings('.modal[aria-label="插入视频"]').show();
        $('.modal-backdrop').eq(1).remove();
    })

    $('#basic').on('click','#closeBtnHelp',function () {
        $(this).parent().parent().parent().parent().hide();
        $('.modal-backdrop').eq(1).remove();
    })
    $('#basic').on('click','#noteBtnHelp',function () {
        $(this).parent().parent().siblings('.modal[aria-label="帮助"]').show();
        $('.modal-backdrop').eq(1).remove();
    })
